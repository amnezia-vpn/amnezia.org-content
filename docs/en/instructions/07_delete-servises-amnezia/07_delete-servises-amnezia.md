# Removing Amnezia services and protocols from the server
...
![instruction 1](https://raw.githubusercontent.com/Aftershock669/amnezia-open-docs/master/docs/ru/instructions/07_delete-servises-amneziaa/img/dsa_ru_1.png)
