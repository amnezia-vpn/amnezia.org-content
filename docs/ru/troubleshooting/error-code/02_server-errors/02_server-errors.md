...
Возникает при установке контейнера с VPN или при добавления файла с конфигурацией.
...
Также возможно повреждение менеджера пакетов. Обратитесь в службу поддержки хостинга.
