...
### 1.3 Amnezia Premium
При покупке подписки через [https://pay.amnezia.org](https://pay.amnezia.org) мы собираем только адрес электронной почты пользователя. IP-адрес пользователя может быть передан платежному шлюзу сайтом [https://pay.amnezia.org](https://pay.amnezia.org) при необходимости, но не сохраняется. После подключения к Amnezia Premium через приложение мы собираем:
...
Сбор осуществляется через self-hosted Matomo, Plausible и Cloudflare Insights. Данные обезличены и не позволяют установить личность пользователя.
...
- отправки предложений и новостей о продуктах (вы можете отписаться в любое время, нажав на ссылку в письме или связавшись с нами).
...
- данные, отправленные через бизнес-форму на сайте [https://amnezia.org/business](https://amnezia.org/business), передаются в сервис Web3Forms (см. их политику конфиденциальности);
- данные, предоставленные через [https://amnezia.org](https://amnezia.org/), могут быть напрямую переданы платежным провайдерам в процессе оплаты (например, адрес электронной почты пользователя и IP-адрес в случаях, когда это требуется платежным провайдером);
- уполномоченным государственным органам исключительно на основании действительного, официального и законного запроса и только в объеме, предусмотренном применимым законодательством.

Никакие иные данные третьим лицам не передаются.
...
Собираются только агрегированные статистические данные. Мы не отслеживаем личные действия пользователей. Вы можете отключить cookie в настройках браузера — это не повлияет на доступ к функционалу.
...
Наши услуги предоставляются «как есть» и «по мере доступности». Мы не предоставляем никаких прямых или подразумеваемых гарантий относительно бесперебойности работы, скорости, безопасности или соответствия услуг конкретным ожиданиям. Amnezia не несет ответственности за:
...
В пределах, допускаемых законом, наша ответственность ограничивается минимальным объёмом, установленным применимым законодательством. Никакие положения этой Политики не исключают и не ограничивают ответственность, если это прямо запрещено законом (например, при умысле или грубой неосторожности).
...
- распространения, хранения или передачи запрещенного контента (включая нарушающего авторские права);
...
Мы не ведем журналы активности, не отслеживаем и не регистрируем трафик пользователей. Однако при получении достоверных уведомлений о нарушениях (например, abuse-репорты от хостинг-провайдеров, операторов связи или правообладателей) мы можем предпринять необходимые меры для защиты нашей инфраструктуры и соблюдения правовых требований.

### 11.2 Контент и сторонние ресурсы
Amnezia не несет ответственности за материалы, размещенные или передаваемые пользователями либо третьими сторонами через наши сервисы. Мы не осуществляем постоянный мониторинг и не контролируем такой контент, но можем принять меры, если это требуется или разрешено законом.
...
## 13. О нас
Сервис управляется компанией ANARCHY LAB S.R.L.
Компания зарегистрирована в Румынии под регистрационным номером J2026000670007,
юридический адрес: Румыния, г. Бухарест, сектор 3, бульвар Унири, д. 61, бл. F3, подъезд 4, этаж 2, кв. 208.

Если у вас есть вопросы, касающиеся Политики, пожалуйста, свяжитесь с нами по адресу электронной почты: privacy@amnezia.org
